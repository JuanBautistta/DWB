...
public class CtrlProduct {
	...
	public ResponseEntity<List<DtoProductList>> getProducts(@PathVariable("category_id") Integer categoryId){
		return new ResponseEntity<>(svc.getProducts(categoryId), HttpStatus.OK);
	}
